...
import { VenueComponent } from './layouts/venue/venue.component';
const routes: Routes = [
  {
    path: '',
    ...
    children: [
      ...
      },
      {
        ...
        loadChildren: () => import('./orderdriver/orderdriver.module').then(m => m.OrderdriverModule),
        canActivate: [AuthGuard]
      },
      {
        path: 'admin-cities',
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'orders',
        loadChildren: () => import('./venueorders/orders.module').then(m => m.OrdersModule),
        //canActivate: [AuthGuard]
      },
      {
        path: 'categories',
        loadChildren: () => import('./venuecategories/category.module').then(m => m.CategoryPageModule),
        //canActivate: [AuthGuard]
      },
      {
        path: 'orderdetails',
        loadChildren: () => import('./venueorderdetails/orderdetails.module').then(m => m.OrderdetailsModule),
        //canActivate: [AuthGuard]
      },
      {
        path: 'food',
      ...
      {
        path: 'add-new-foods',
        loadChildren: () =>  import('./add-new-foods/add-new-foods.module').then(m => m.AddNewFoodsPageModule),
        //canActivate: [AuthGuard]
      }
    ]
  },
